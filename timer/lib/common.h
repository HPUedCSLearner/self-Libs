...
#define default_module_num (20)

// #define stack_overflow_check_on
...
{
    ULL funcAddr;
    ULL faterAddr; // father
}KEY;

typedef struct VALUE
{
    int times[default_module_num];
    ULL acctime[default_module_num];
    ULL sheltime[default_module_num];
}VALUE;
